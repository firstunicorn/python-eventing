...
See Also
--------
- messaging.infrastructure.pubsub.kafka_consumer_base : The consumer base class that uses this
- messaging.infrastructure.persistence.processed_message_store : The SQLAlchemy implementation
"""
